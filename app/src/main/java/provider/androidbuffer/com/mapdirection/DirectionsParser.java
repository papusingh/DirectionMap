package provider.androidbuffer.com.mapdirection;
...
/**
 * Created by incred-dev on 24/8/18.
 */
                ...
                for (int j = 0; j < jLegs.length(); j++){
                    ...
                    for (int k = 0; k < jSteps.length(); k++){
                        ...
                        for (int l = 0; l < list.size(); l++){
                            ...
                            Log.d("direction lat",Double.toString(((LatLng) list.get(l)).latitude));
                            Log.d("direction lon",Double.toString(((LatLng) list.get(l)).longitude));
                            path.add(hm);
                        }
                    }
                    routes.add(path);
